...
import { uploadmusic ,songInfo,SingleSongInfo,getAllSongs,searchSong,deleteSong, editSong,userInfo,approveSong,getAllUnverifiedSongs,getSongsForAdmin,searchSongForAdmin,downloadCounter,getAdminDashboard,getTrendingSongs,getRandomSongs,getSignUrl} from "../controllers/uploadController.js";


router.route("/uploadmusic").post(uploadmusic);
router.route("/getSignUrl").post(getSignUrl)
